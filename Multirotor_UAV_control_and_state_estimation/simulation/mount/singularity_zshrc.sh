...
[ -e ~/task_01_controller/simulation/user_ros_workspace/devel/setup.bash ] && source ~/task_01_controller/simulation/user_ros_workspace/devel/setup.bash
...
export ROS_WORKSPACES="$ROS_WORKSPACES /opt/mrs/mrs_workspace ~/task_01_controller/simulation/user_ros_workspace"
