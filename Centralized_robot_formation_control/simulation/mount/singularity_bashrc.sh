...
[ -e ~/task_02_formation/simulation/user_ros_workspace/devel/setup.bash ] && source ~/task_02_formation/simulation/user_ros_workspace/devel/setup.bash
...
export ROS_WORKSPACES="$ROS_WORKSPACES /opt/mrs/mrs_workspace ~/task_02_formation/simulation/user_ros_workspace"
